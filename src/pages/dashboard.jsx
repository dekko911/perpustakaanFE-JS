...
export const DashboardPage = () => {
	...
	useEffect(() => {
		const getCount = async () => {
			...
			// roles
			const getRoles = await axios.get(`${api_url}/api/roles`, {
				headers: {
					Authorization: `Bearer ${api_token}`,
					"Content-Type": "application/json",
				},
			...
			// books
			const getBooks = await axios.get(`${api_url}/api/books`, {
				headers: {
					Authorization: `Bearer ${api_token}`,
					"Content-Type": "application/json",
				},
			...
			// members
			const getMembers = await axios.get(`${api_url}/api/members`, {
				headers: {
					Authorization: `Bearer ${api_token}`,
					"Content-Type": "application/json",
				},
			...
			// circulations
			const getCirculations = await axios.get(`${api_url}/api/circulations`, {
				headers: {
					Authorization: `Bearer ${api_token}`,
					"Content-Type": "application/json",
				},
